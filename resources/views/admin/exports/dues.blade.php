...
<table class="table" style="padding:20px;" id="myTable">
    ...
    <tbody>
        ...
        foreach ($students as $student) {
            ...
            if ($_GET['section'] == null && $_GET['class'] !== null) {
                if ($student->getStudent->class == $_GET['class']) {
                    ...
                    U.K.G
                    @endif
                    @if($student->getStudent->class !== 100 && $student->getStudent->class !== 101 &&$student->getStudent->class !== 102)
                    <?php
            ...
            } elseif ($_GET['class'] == "" && $_GET['section'] == "") {
                echo "<h1>Hello</h1>";
            } elseif ($_GET['section'] !== null && $_GET['class'] !== null) {
